package com.keygun2001.addon.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(Sentinel.HUD_GROUP, "example", "HUD element example.", HudExample::new);
